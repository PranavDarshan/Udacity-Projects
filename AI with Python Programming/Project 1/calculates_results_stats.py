...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # Dog breed provided by image classifier is correct
    ...
    # calculates pct_match
    # checks if n_images > 0 to avoid division by 0 error 
    if results_stats_dic['n_images'] > 0:
        results_stats_dic['pct_match'] = results_stats_dic['n_match']/results_stats_dic['n_images']*100
    
    #checks if n_dogs_img > 0 to avoid division by 0 error
    if results_stats_dic['n_dogs_img'] > 0:
        
        # calculates pct_correct_dogs and pct_correct_breed
        results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img']) * 100
        results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img']) * 100
    
    else:
        results_stats_dic['pct_correct_dogs'] = results_stats_dic['pct_correct_breed'] = 0.0
   
   
    # Calculates % correct not-a-dog images
    # Uses conditional statement for when no 'not a dog' images were submitted
    # checks if n_notdogs_img > 0 to avoid division by 0 error 
